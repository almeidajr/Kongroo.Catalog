...
namespace Kongroo.Catalog.Infrastructure.Migrations
{
    ...
    public partial class AddMassTransitOutbox : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "outbox_message", schema: "catalog");

            migrationBuilder.DropTable(name: "inbox_state", schema: "catalog");

            migrationBuilder.DropTable(name: "outbox_state", schema: "catalog");
